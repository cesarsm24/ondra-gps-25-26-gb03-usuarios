...
/**
 * Repositorio para la gestión de métodos de pago de usuarios.
 *
 * <p>Proporciona operaciones de acceso a datos para métodos de pago,
 * incluyendo consultas por usuario y validación de propiedad.</p>
 */
@Repository
public interface MetodoPagoUsuarioRepository extends JpaRepository<MetodoPagoUsuario, Long> {
    ...
    /**
     * Busca un método de pago verificando que pertenezca al usuario.
     *
     * @param id identificador del método de pago
     * @param usuario entidad del usuario propietario
     * @return Optional con el método de pago si pertenece al usuario
     */
