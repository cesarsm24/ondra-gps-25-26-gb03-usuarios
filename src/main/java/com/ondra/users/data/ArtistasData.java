 ...
 */
public final class ArtistasData {
    ...
    public static class ArtistaInfo {
         ...
         */
        private final boolean esTendencia;
     ...
     */
    public static final List<ArtistaInfo> ARTISTAS_PREDEFINIDOS = List.of(
            new ArtistaInfo(
                    "Duki",
                    ...
                    List.of(INSTAGRAM, X, SPOTIFY, YOUTUBE, TIKTOK, FACEBOOK),
                    true,
            ...
            new ArtistaInfo(
                    ...
                    List.of(INSTAGRAM, X, SPOTIFY, YOUTUBE, FACEBOOK),
                    false,
            ...
            new ArtistaInfo(
                    ...
                    List.of(INSTAGRAM, X, SPOTIFY, YOUTUBE, FACEBOOK, TIKTOK),
                    true,
            ...
            new ArtistaInfo(
                    ...
                    List.of(INSTAGRAM, X, SPOTIFY, YOUTUBE, TIKTOK),
                    true,
