...
public class UsuariosData {
    ...
    public static final List<UsuarioInfo> USUARIOS_PREDEFINIDOS = Arrays.asList(
            ...
            new UsuarioInfo("David", "López Martín", "david.lopez", "david"),
            new UsuarioInfo("Elena", "Sánchez Gómez", "elena.sanchez", "elena"),
            new UsuarioInfo("Javier", "Pérez Jiménez", "javier.perez", "javier"),
            new UsuarioInfo("María", "Romero Díaz", "maria.romero", "maria"),
            new UsuarioInfo("Pablo", "Moreno Álvarez", "pablo.moreno", "pablo")
    );
